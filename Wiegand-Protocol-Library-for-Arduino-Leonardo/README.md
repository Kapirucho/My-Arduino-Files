...
Arduino Leonardo Any compatible board should work.

Wiegand RFID Reader.

Reader 1 :

DATA0 of Wiegand connects to Arduino PIN 3 
DATA1 of Wiegand connects to Arduino PIN 2

Reader 2 :
DATA0 of Wiegand connects to Arduino PIN 0 
DATA1 of Wiegand connects to Arduino PIN 1
...
Modified by: Alejandro Suarez (@kapiu) This file can work with Arduino Leonardo
